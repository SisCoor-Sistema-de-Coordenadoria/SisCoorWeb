...
<tag:header_inicio title="SisCoor Web - Servidor" titlePage="SisCoor Web | Servidor" caminho="../resources" paramVolta="../../SisCoorWeb" servidorAtivo="active"/>
                ...
                <div class="form-body pal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-icon right">
                                <i class="fa fa-user"></i>
                                <input name="suap" id="inputSuap" type="text" placeholder="" class="form-control" /></div>
                        </div>
                    </div>
                    <div class="form-group">
