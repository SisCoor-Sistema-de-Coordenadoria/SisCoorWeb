...
<tag:header_inicio title="SisCoor Web - Servidor" titlePage="SisCoor Web | Servidor" caminho="../resources" paramVolta="../" servidorAtivo="active"/>
...
<div id="alert_danger" class="alert alert-danger col-lg-12" role="alert" style="text-align: center">
    ...
    <strong>Número do Suap e/ou Senha incorreto(s)!</strong>
    <%
            session.setAttribute("erro_login", null);
        }
    %>
            ...
            <form action="../AutenticadorServidor" class="form-horizontal" method="post">
                <div class="form-body pal">
                    <div class="form-group">
                        <label for="inputSuap" class="col-md-3 control-label">
                            Núm. do Suap: </label>
                        <div class="col-md-9">
                            <div class="input-icon right">
                                <i class="fa fa-user"></i>
                                <input name="suap" id="inputSuap" type="text" class="form-control" /></div>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-actions pal">
                    <div class="form-group mbn">
                        <div class="col-md-offset-3 col-md-6">
                            <a href="cadastro_servidor.jsp" class="btn btn-primary">Cadastre-se</a>&nbsp;&nbsp;
