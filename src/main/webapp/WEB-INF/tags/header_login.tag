                ...
                <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
                    ...
                    <div class="sidebar-collapse menu-scroll">
                        <ul id="side-menu" class="nav">
                            ...
                            <li class='${alunoAtivo}'><a href="${paramVolta}/tela_login/LoginAluno.jsp"><i class="fa fa-tachometer fa-fw">
                                        <div class="icon-bg bg-orange"></div>
                                    </i><span class="menu-title">Aluno</span></a></li>

                                    <li class="${servidorAtivo}"><a href="${paramVolta}/tela_login/LoginServidor.jsp"><i class="fa fa-desktop fa-fw">
