<%-- 
    ...
    Created on : 09/06/2017, 17:52:19
    Author     : Diego
--%>
...
<tag:header caminho="../resources" paramVolta="../../SisCoorWeb" titlePage="Módulo | Gerenciar Conteúdo | Novo Aluno" title="SisCoor | Gerenciar Conteúdo | Novo Aluno" usuario="<%=(String) session.getAttribute("nomeUsuario")%>" crudMenuConteudoAtivo="active"/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputMatricula" class="control-label">
                                    <strong>*</strong>Nº de Matricula
                                </label>
                                <div class="input-icon right">
                                    <i class="fa fa-user"></i>
                                    <input id="inputMatricula" class="form-control" placeholder="Somente números" type="text" value="" name="matricula"/>
                                </div>
                            </div>
                        </div>
