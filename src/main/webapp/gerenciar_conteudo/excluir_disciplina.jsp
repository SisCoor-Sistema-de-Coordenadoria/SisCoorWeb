<%-- 
    ...
    Created on : 31/05/2017, 17:49:23
    Author     : Diego
--%>
            ...
            <div class="form-body pal">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <%if(session.getAttribute("Dados_excluir_disciplina")!=null)
                        {
                            Disciplina disciplina = new Disciplina();
                            disciplina=(Disciplina)session.getAttribute("Dados_excluir_disciplina");
                            session.setAttribute("Dados_excluir_disciplina", null);
                        %>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    ...
                                    <input readonly="true" class="form-control" type="text" value="<%=disciplina.getCargaHora()%>" name="ch"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    ...
                                    <input readonly="true" class="form-control" type="text" value="<%=disciplina.getNome()%>" name="nomeDisciplina"/>
                                </div>
                            </div>
                        </div>
